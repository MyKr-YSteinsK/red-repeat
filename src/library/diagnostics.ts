...
export type DiagnosticCode =
  ...
  | 'TIMELINE_AUDIO_SOURCE_MISMATCH'
  ...
  | 'PRACTICE_DUPLICATE_UNIT_ID'
  | 'PRACTICE_UNKNOWN_SECTION'
  | 'PRACTICE_UNKNOWN_OCCURRENCE'
  | 'PRACTICE_DUPLICATE_OCCURRENCE'
  | 'PRACTICE_OCCURRENCE_MULTI_ASSIGNMENT'
  | 'PRACTICE_SECTION_MISMATCH'
  | 'PRACTICE_OCCURRENCE_OUT_OF_ORDER'
  | 'PRACTICE_UNIT_OUT_OF_ORDER'
  | 'PRACTICE_OCCURRENCE_UNCOVERED'
  | 'SOURCE_READ_ERROR'
